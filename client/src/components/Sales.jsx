...
import { ShoppingCart, FileText, CheckCircle, AlertCircle } from 'lucide-react';
import { createSale, fetchSales, fetchInventory } from '../services/api';
...
const Sales = () => {
    ...
    const [formData, setFormData] = useState({
        customer_name: '',
        rice_variety: '', // Will populate from Inventory
        grade: 'Standard',
        bag_size: 50,
        quantity_bags: '',
        rate_per_bag: '',
    ...
    const loadInventory = async () => {
        try {
            ...
            setInventory(data);
            // Auto-select first variety if empty
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            loadInventory(); // Update stock availability
        } catch (err) {
    ...
    // Unique Rice Varieties for Dropdown
