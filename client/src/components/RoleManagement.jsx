...
const RoleManagement = () => {
    ...
    const handlePermissionChange = (roleName, module, type) => {
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px' }}>
                {roles.map(role => (
                    <div key={role._id} className="glass-panel" style={{ padding: '20px' }}>
                        ...
                        <div style={{ display: 'flex', colspan: '2', marginBottom: '10px', fontSize: '0.8rem', color: 'var(--text-secondary)', fontWeight: '600' }}>
